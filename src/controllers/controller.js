	...
	async insertOrUpdateQuery(table, values) {
		switch (this.config.database.client) {
			...
			default: {
				const constraints = {
					humans: 'id',
					monsters: 'monsters.id, monsters.pokemon_id, monsters.min_iv, monsters.max_iv, monsters.min_level, monsters.max_level, monsters.atk, monsters.def, monsters.sta, monsters.form, monsters.gender, monsters.great_league_ranking, monsters.ultra_league_ranking, timer, monsters.little_league_ranking',
